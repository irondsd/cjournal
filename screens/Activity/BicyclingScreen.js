...
class RunningScreen extends Component {
    ...
    record() {
        ...
        // tasks_id, null, activity_types.Bicycling, this.state.startDate, endDate, '', data
        ...
        return (
            <View style={styles.container}>
                {/* <Text style={styles.text}>
                    {strings.Steps}: {this.state.numberOfSteps}, {strings.Distance}: {this.state.distance}
                </Text> */}
