export const en = {
    ...
    MicrophonePermissionsMessage:   'Cardio Journal needs access to your microphone',
    minute: 'minute',
    minutes: 'minutes',
    mmHg: 'mmHg',
    Nausea: 'Nausea',
    ...
    StoragePermissionsMessage:   'Cardio Journal needs access to your internal storage',
    Straining: 'Straining',
    ...
    Tasks: 'Tasks',
    Terminate: 'Terminate',
    TerminationExerciseQuestion:   'Do you really want to terminate the exercise? It cannot be undone',
    Tests: 'Tests',
    Time: 'Time',
    Today: 'Today',
    Toilet: 'Toilet',
