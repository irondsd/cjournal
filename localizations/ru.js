export const ru = {
    ...
    StoragePermissionsMessage: 'Cardio Journal нужен доступ к внутреннему хранилищу',
    ...
    Tasks: 'Задания',
    Terminate: 'Прервать',
    TerminationExerciseQuestion: 'Вы действительно хотите прервать задание? Это необратимое действие',
    Tests: 'Пробы',
    Time: 'Время',
    Today: 'Сегодня',
    Toilet: 'Tуалет',
