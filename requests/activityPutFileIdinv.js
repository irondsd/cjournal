...
export default async function activityPostData(idinv, access_token, activity) {
    const uploadUrl = apiUrl + `idinv/${idinv}/activity//${activity.id}`
    var files = []
    ...
    let fields = { ...activity, idinv: idinv }
